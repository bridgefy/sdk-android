package me.bridgefy.example.android.alerts.ui.compose.setting
    ...
    AppTheme {
        Surface {
            ...
            Column(
                ...
                Setting.Clickable(
                    text = "Work Manager Status",
                    secondaryText = "Show status of all background workers",
                ) { }
                Setting.Clickable(
                    text = "Last Installed Version Code",
                    currentLastInstalledVersionCodeFlow,
                ) { }
            }
        }
    }
